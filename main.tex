...
% Topic descriptions — one line per topic, surfaced on the web site's Topics
% catalog.  Keep the text plain (no braces, backslashes, or LaTeX markup).
\topic{Control Theory}{Feedback, stability, and the dynamics of systems that regulate themselves.}
\topic{Electromagnetism}{Electric and magnetic fields and their interplay: forces on charges, circuits, and electromagnetic phenomena.}
\topic{Fluid Mechanics}{The behavior of fluids: pressure, viscosity, and flow at rest and in motion.}
\topic{Gravitation}{Newtonian gravity, orbital motion, and the dynamics of bodies moving under universal attraction.}
\topic{Mechanics}{The motion of objects and the forces, energy, and momentum that govern it, from point masses on tracks to rigid-body rotation.}
\topic{Optics}{The behavior of light: reflection, refraction, imaging, and how optical systems and cameras form images.}

% Setter contacts — optional, one line per contact method.  Use `mailto:…` for
% email and a direct URL otherwise.  Keep plain (no braces, backslashes, or %).
\setterContact{Sean Li}{Email}{mailto:makabaka1880@outlook.com}
\setterContact{Sean Li}{GitHub}{https://github.com/makabaka1880}
\setterContact{Sean Li}{HomePage}{https://blog.makabaka1880.xyz}
\setterContact{Sophie Chen}{Email}{mailto:sophiec2010@163.com}
\setterContact{CollegeBoard}{HomePage}{https://www.collegeboard.org}
